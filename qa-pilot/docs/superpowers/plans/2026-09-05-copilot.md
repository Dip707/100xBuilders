...
- [x] **Step 5: Update the Mongo store**
...
- [x] **Step 6: Give existing chat creation a kind**
...
- [x] **Step 7: Run the store, chat and API tests**
...
- [x] **Step 4: Write the file from the report node**
...
- [x] **Step 5: Assert it in the graph test**
...
- [x] **Step 3: Extend the API client**
...
- [x] **Step 3: Export the credentials row**
...
- [x] **Step 1: Make the attach button optional in the composer**
...
- [x] **Step 4: Typecheck, lint and run all UI tests**
